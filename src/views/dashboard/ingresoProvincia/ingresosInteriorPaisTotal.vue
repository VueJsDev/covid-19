            ...
            <div class="m-portlet__head-caption">
                <div class="m-portlet__head-title">
                    ...
                    <h3 class="m-portlet__head-text">
                        INGRESOS DEL INTERIOR DEL PAIS
                    </h3>
                </div>
            </div>
        </div>
                        ...
                        <span class="m-section__sub">
                            <center>
                                <div class="alturaFija">
                                    <h6>Total de ingresos del interior del Pais</h6>
                                </div>
                            </center>
                        </span>
                        <div class="m-section__content">
                            <center>
                                <div class="circleViolet">
                                    <h2>
   ...
   import { mapActions, mapGetters} from 'vuex';
    ...
    export default {
        ...
        methods: {
            ...
            updateScreen(code){
                //console.log("### UPDATE PAGE BY DATE AND CODE BY WITHIN COUNTRY ###");

                if(this.GET_TOTALS.Interior === 0) return;
        ...
        computed: {
            ...
            computedTotalIncomeWithinCountry(){
                return isNaN(Intl.NumberFormat("de-DE").format(this.GET_TOTALS.Interior)) 
                    ? '-' 
                    : Intl.NumberFormat("de-DE").format(this.GET_TOTALS.Interior);
            },

            isDisabled() {
                if(this.GET_TOTALS.Interior === 0 || this.GET_TOTALS.Interior == "-") {
                    return true;
                }
                else {
                    return false;
